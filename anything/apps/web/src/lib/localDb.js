...
const fromInvoiceRow = (row) => {
  ...
  return {
    ...
    advertiser_id: row.advertiser_id || '',
    advertiser_name: row.advertiser_name || '',
    amount: toMoney(row.amount ?? row.total ?? row.amount_paid),
    ...
    tax: toMoney(row.tax),
    total: toMoney(row.total ?? row.amount ?? row.amount_paid),
    notes: row.notes || '',
...
const toInvoiceRow = (input) => ({
  ...
  advertiser_id: input.advertiser_id || null,
  advertiser_name: String(input.advertiser_name || '').trim(),
  amount: toMoney(input.amount ?? input.total ?? input.amount_paid),
  ...
  total: toMoney(input.total ?? input.amount ?? input.amount_paid),
  notes: String(input.notes || '').trim(),
